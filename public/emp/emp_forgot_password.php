...
$resetPassword = $emp->empResetPassword();
...
<body>
    ...
    <div class="container">
        ...
        <div class="login-form">
            <div class="title">
                RESET PASSWORD <span id="user-type">Employee.</span>
            </div>
            ...
            <?php
                if(isset($resetPassword) && $resetPassword[1] == "success"){
                    ...
                    ?>
                        ...
                        <div class="inputs">
                            <div class="input-label">
                                Password changed succesfully! You can now log-in using your new password. <a href="emp_login.php">Log-in?</a>
                            </div>
                        </div>
                    ...
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" class="inputs">
                        <label for="empEmail" class="input-label">
                            Email
                        </label>
                            <input type="text" name="empEmail" id="empEmail" class="input-area" placeholder="enter your email..." required="required" autocomplete="off">
