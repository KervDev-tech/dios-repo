<div id="content-div">
            <div id="signup-form-div">
                <div id="form-heading-div">
                    <div id="form-heading">
                        SIGN UP <span id="user-type">Employee.</span>
                    </div>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" id="signup-form">
                    ...
                    <div class="inputs-div-divider">
                        ...
                        <div class="inputs-div">
                            ...
                            <input type="text" name="lastName" id="lastName" class="input-field" placeholder="Thrii" onkeyup="letterSpaceOnly('lastName', 'ln-error', 'signup-btn')" required="required">
                    ...
                    <div class="inputs-div-divider">
                        <div class="inputs-div">
                            ...
                            <input type="text" name="emergName" id="emergName" class="input-field" placeholder="..." onkeyup="letterSpaceOnly('emergName', 'emergName-error', 'signup-btn')" required="required">
                        ...
                        <div class="inputs-div">
                            ...
                            <input type="text" name="emergRel" id="emergRel" class="input-field" placeholder="..." onkeyup="letterSpaceOnly('emergRel', 'emergRel-error', 'signup-btn')" required="required">
                        ...
                        <div class="inputs-div">
                            ...
                            <input type="text" name="emergNum" id="emergNum" class="input-field" placeholder="..." onkeyup="numbersOnly('emergNum', 'emergNum-error', 'signup-btn')" required="required">
                        ...
                        <div class="inputs-div">
                            ...
                            <input type="text" name="emergAdd" id="emergAdd" class="input-field" placeholder="..." onkeyup="letterNumSpaceOnly('emergAdd', 'emergAdd-error', 'signup-btn')" required="required">
